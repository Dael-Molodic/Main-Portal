const eagle = "adler-g2e6da9b74_1920.jpg";
const bee = "bee-gebb4da018_1920.jpg";
const dog = "husky-gdea9055db_1920.jpg";
const butterfly = "butterfly-gcaee594c1_1920.jpg";
const cat = "cat-g584c10027_1920.jpg";
const gorilla = "gorilla-g34d83e689_1920.jpg";
const horse = "horse-g1980fd91a_1920.jpg";
const lion = "lion-gf614e669d_1920.jpg";
const owl = "owl-g01799629f_1920.jpg";
const parrot = "macaw-gbb46da5b2_1920.jpg";
const swan = "swan-g29c8eba9d_1920.jpg"; 
const tiger = "tiger-gcfa76313d_1280.jpg";

const avocado = "avocado-g086bb1005_1920.jpg";
const banana = "banana-gfeb210ea6_1920.jpg";
const sushi = "food-g07f5edcc9_1920.jpg";
const egg = "fried-egg-ga47c35bbb_1920.jpg";
const hamburger = "hamburger-g925a28380_1920.jpg";
const hotDog = "hot-g0620148f4_640.jpg";
const iceCream = "ice-cream-g348718e59_1920.jpg";
const Bolognese = "meal-g2528ef854_1920.jpg";
const pizza = "pizza-g9f4c0b010_1920.jpg";
const salad = "salad-g5ab8678f8_1920.jpg";
const schnitzel = "schnitzel-g11f0ec502_1920.jpg";
const steak = "steak-g9f0b41bc7_1920.jpg";
...
function createPlayer(playerNum) {
    ...
    if (localStorage.playerArr != undefined && ( (!computer) || playerNum==0 )) {

        playerImg.style.backgroundImage = `url("${JSON.parse(localStorage.playerArr)[playerNum].avatar}")`;
...
function whoIsWinner() {
    ...
    addScoreToMemo(A, B, C, player1, player2, player3);
...
function addScoreToMemo(score0, score1, score2, nickname0, nickname1, nickname2) {
    ...
    localStorage.setItem(`${nickname0}Score`, Number((localStorage.getItem(`${nickname0}Score`))) + score0);

    if (playerArr.length > 1) {
        localStorage.setItem(`${nickname1}Score`, Number((localStorage.getItem(`${nickname1}Score`))) + score1);
    }

    if (playerArr.length > 2) {
        localStorage.setItem(`${nickname2}Score`, Number((localStorage.getItem(`${nickname2}Score`))) + score2);
    }
